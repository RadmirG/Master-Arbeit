...
%\include{captures/3_Inverse_Probleme}

%\include{captures/4_Rekonstruktionsverfahren}

%\include{captures/ausblick}
...
%%%Anhang
\appendix
\include{captures/anhang_a}	% Technische Ergänzungen
\include{captures/anhang_b}	% Inhalt der CD-ROM/DVD
