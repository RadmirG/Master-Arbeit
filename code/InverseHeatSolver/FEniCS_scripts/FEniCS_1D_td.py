...
np.savez("sol_1D_td_1000x1000.npz", u_sol=u_sol, X_test=X_test, T_test=T_test)
...
Visualizer.plot_1D(X_test[0,:], u_sol[0,:], X_test, None, None, None, a_values[0], None,
                   u_values[0], None, None, title=r"Approximierte Lösung $u_l(x)$")

Visualizer.plot_3d(X_test, T_test, u_sol, u_sol, a_values, is_time_plot=True)

#Visualizer.time_plot(space_dom, range_t, sizeof_t, u_sol, None, None,
#                     functions.u_1D_td, None, functions.a_1D_td)
